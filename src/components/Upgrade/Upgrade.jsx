...
import { upgradeData } from "../../data/Links";
...
export default function Upgrade() {
  ...
  return (
    <div
      className={`${Style.upgradeCard} ${menuToggle ? Style.upgradeCardHide : ""}`}
    >
      <div className={Style.sidebarCircle}>
        <svg
          width="41"
          height="41"
          viewBox="0 0 41 41"
      ...
      <h5 className={Style.upgradeCardText}>{upgradeData.title}</h5>
      <p className={Style.upgradeCardPara}>{upgradeData.description}</p>
    </div>
  );
}
